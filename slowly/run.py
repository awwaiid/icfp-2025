#!/usr/bin/env python3
"""
Run script for the slowly approach
Usage: python slowly/run.py <problem_name> <room_count>
Example: python slowly/run.py secundus 12
"""

import sys
import os

# Add the parent directory to the path so we can import slowly.problem
...
def main():
    if len(sys.argv) < 3 or len(sys.argv) > 4:
        print("Usage: python slowly/run.py <problem_name> <room_count> [--no-select]")
