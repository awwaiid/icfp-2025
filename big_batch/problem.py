...
class Problem:
    ...
    def explore_all_pending_batched(self):
        ...
        print(f"BATCH: Found {len(pending_paths)} pending explorations to send in one batch")
    ...
    def explore_until_complete_batched(self, max_iterations: int = 10000):
        """NEW: Keep exploring using big batches until all rooms are complete"""
        print("=== Big-Batch Exploring Until Complete ===")
