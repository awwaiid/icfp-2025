"""
Example usage of the ambiguously approach
"""
...
def example_bootstrap():
    ...
    print("=== Ambiguously Bootstrap Example ===")
...
if __name__ == "__main__":
    ...
    p1.save_observations("ambiguously_bootstrap.json")

    p2 = example_incremental_exploration()
    p2.save_observations("ambiguously_complete.json")
